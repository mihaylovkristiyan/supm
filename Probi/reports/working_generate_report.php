...
if ($report_type !== 'animal_objects' && $report_type !== 'plateni_fakturi' && (!isset($_GET['start_date']) || !isset($_GET['end_date']))) {
    header('HTTP/1.1 400 Bad Request');
...
if (isset($start_date) && isset($end_date) && $report_type !== 'animal_objects' && $report_type !== 'plateni_fakturi') {
